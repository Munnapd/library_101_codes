...
def BorrowBookView(request, id):
    ...
    # Return to the profile page or wherever you want to redirect in case of failure
    return redirect('profile')  # Make sure to return an HttpResponse in all cases
...
def ReturnBook(request, id):
    ...
    # Get the specific borrow instance for the user and the book
    borrow_instance = Borrow.objects.filter(book=book, user=request.user, return_date__isnull=True).first()
